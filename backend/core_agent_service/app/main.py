"""Main FastAPI application for Core Agent Service."""
...
app = FastAPI(
    ...
    description="Main orchestrator service for TestOps Copilot",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def health_check():
    ...
    return {"status": "healthy", "service": "core-agent-service"}
